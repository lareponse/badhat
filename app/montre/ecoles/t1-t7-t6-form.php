...
<section class="tight" aria-labelledby="environnement-heading">
    ...
    <figure>
        <label>Image 1 : <input type="file" name="env_img_1"></label>
        <label>Image 2 : <input type="file" name="env_img_2"></label>
        <label>Image 3 : <input type="file" name="env_img_3"></label>
    </figure>
</section>
