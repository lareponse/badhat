...
<body>
    ...
    <div id="accessibility-menu" aria-hidden="true">
        ...
        <div class="options" role="group" aria-labelledby="accessibility-title">
            <!-- Lire la page -->
            <button class="action" data-action="readPage" aria-pressed="false">
                <span class="icon icon-reading"></span>
                <span class="label">Lire la page</span>
            </button>

            <!-- Contraste -->
            <button class="action" data-action="contrast" aria-pressed="false">
                <span class="icon icon-contrast"></span>
                <span class="label">Contraster</span>
            </button>

            <!-- Contraste intelligent -->
            <button class="action" data-action="smartContrast" aria-pressed="false">
                <span class="icon icon-smart-contrast"></span>
                <span class="label">Contraste intelligent</span>
            </button>

            <!-- Surligner liens -->
            <button class="action" data-action="highlightLinks" aria-pressed="false">
                <span class="icon icon-highlight-links"></span>
                <span class="label">Surligner les liens</span>
            </button>

            <!-- Agrandir le texte -->
            <button class="action" data-action="increaseText" aria-pressed="false">
                <span class="icon icon-bigger-text"></span>
                <span class="label">Agrandir le texte</span>
            </button>

            <!-- Espacer le texte -->
            <button class="action" data-action="textSpacing" aria-pressed="false">
                <span class="icon icon-spacing"></span>
                <span class="label">Espacer le texte</span>
            </button>

            <!-- Activer animations -->
            <button class="action" data-action="toggleAnimations" aria-pressed="true">
                <span class="icon icon-animations"></span>
                <span class="label">Activer animations</span>
            </button>

            <!-- Masquer images -->
            <button class="action" data-action="hideImages" aria-pressed="false">
                <span class="icon icon-hide-images"></span>
                <span class="label">Masquer les images</span>
            </button>

            <!-- Mode dyslexie -->
            <button class="action" data-action="dyslexiaFont" aria-pressed="false">
                <span class="icon icon-dyslexia"></span>
                <span class="label">Mode dyslexie</span>
            </button>

            <!-- Agrandir curseur -->
            <button class="action" data-action="bigCursor" aria-pressed="false">
                <span class="icon icon-cursor"></span>
                <span class="label">Agrandir curseur</span>
            </button>

            <!-- Info-bulles -->
            <button class="action" data-action="tooltips" aria-pressed="true">
                <span class="icon icon-tooltips"></span>
                <span class="label">Info-bulles</span>
            </button>

            <!-- Plan de page -->
            <button class="action" data-action="pageOutline" aria-pressed="false">
                <span class="icon icon-outline"></span>
                <span class="label">Plan de page</span>
            </button>

            <!-- Hauteur de ligne -->
            <button class="action" data-action="lineHeight" aria-pressed="false">
                <span class="icon icon-line-height"></span>
                <span class="label">Hauteur de ligne</span>
            </button>

            <!-- Aligner le texte -->
            <button class="action" data-action="textAlign" aria-pressed="false">
                <span class="icon icon-text-align"></span>
                <span class="label">Aligner le texte</span>
            </button>

            <!-- Saturation -->
            <button class="action" data-action="saturation" aria-pressed="false">
                <span class="icon icon-saturation"></span>
                <span class="label">Saturation</span>
            </button>

            <!-- Réinitialiser -->
            <button class="action reset" data-action="reset">
